                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            className="p-8 bg-gray-50 dark:bg-gray-800 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 transition-all duration-300 group"
                        >
                            {/* Icon Container */}
                            ...
                            {/* Title & Desc */}
                            <h3 className="text-xl font-black text-gray-900 dark:text-white uppercase mb-4 tracking-tight">
                                {service.title}
                            </h3>
